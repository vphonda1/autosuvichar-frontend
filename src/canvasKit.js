...
export function useImageCache() {
  ...
  const get = useCallback((src) => {
    ...
    //    मेल नहीं खाता और 404 देता है — इसलिए उसे साफ़ करना पड़ता है।
    //
    //    पर यह सफ़ाई सिर्फ़ http/https वाले पते पर होनी चाहिए। data: और
    //    blob: को छूना ख़तरनाक है — base64 में "//" बहुत आम है (जैसे
    //    "...AA//8AAAA..."), और उसे "/" कर देने से पूरी तस्वीर का data
    //    ख़राब हो जाता है और वह खुलती ही नहीं। AI से बनी पृष्ठभूमि इसी
    //    वजह से poster पर नहीं लग रही थी।
