...
export default function App() {
  ...
  const TABS = [["content", "📝 कंटेंट"], ["promo", "📣 विज्ञापन+"], ["mega", "🔥 Mega Offer"], ["booking", "📋 बुकिंग"], ["multibike", "🏍️ Multi Bike"], ["hiring", "💼 भर्ती"], ["luckydraw", "🎉 Lucky Draw"], ["delivery", "🎥 Delivery"], ["leads", "👥 Leads"], ["analytics", "📊 Analytics"], ["notif", "🔔"], ...(isAdmin ? [["settings", "⚙️ Settings"]] : [])];
