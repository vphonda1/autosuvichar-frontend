...
export default function App() {
  ...
  const TABS = [["home", "🏠 होम"], ["queue", "📋 Queue"], ["ai", "🤖 AI बनाओ"], ["automkt", "🚀 Auto Marketing"], ["autoengine", "⚡ एक साथ / अपने आप"], ["aidelivery", "📸 AI Delivery"], ["aivideo", "🎬 AI Video"], ["aivoice", "🎙️ AI आवाज़"], ["aistudio", "📱 Platform + Versions"], ["ainews", "📰 खबरें"], ["content", "📝 कंटेंट"], ["promo", "📣 विज्ञापन+"], ["mega", "🔥 Mega Offer"], ["booking", "📋 बुकिंग"], ["multibike", "🏍️ Multi Bike"], ["hiring", "💼 भर्ती"], ["luckydraw", "🎉 Lucky Draw"], ["delivery", "🎥 Delivery"], ["leads", "👥 Leads"], ["analytics", "📊 Analytics"], ["aireport", "🧠 AI Report"], ["vehicles", "🏍️ गाड़ियाँ"], ["memory", "🧠 Brand Memory"], ["automation", "🎛️ Automation"], ["maint", "🧹 रखरखाव"], ["logos", "🖼️ Logo"], ["notif", "🔔"], ...(isAdmin ? [["settings", "⚙️ Settings"]] : [])];
