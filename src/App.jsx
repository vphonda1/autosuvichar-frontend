            ...
            <div key={p._id} className="rounded-2xl bg-neutral-900 border border-neutral-800 overflow-hidden">
              ...
              {!p.video && (p.imgUrl || p.images?.square) && (
                <div className="flex gap-1 bg-neutral-800 border-t border-neutral-700">
                  ...
                  <button onClick={() => setCropItem(p)} className="flex-1 text-center text-xs py-2 text-neutral-200 border-l border-neutral-700">✂️ Crop / Edit</button>
                </div>
              )}
              <div className="p-3">
                ...
                {/* 📤 Native Share */}
                <button onClick={() => nativeShare(p)} className="w-full rounded-lg py-2.5 text-sm font-bold mb-2 flex items-center justify-center gap-2 active:opacity-70" style={{ background: brand.accent, color: "#fff" }}>
                  📤 अभी Share करें
                </button>
          ...
          <div className="space-y-3 pb-10">{deliv.map((d) => (
            <div key={d._id} className="rounded-2xl bg-neutral-900 border border-neutral-800 overflow-hidden">
              ...
              <div className="p-3">
                ...
                {ADMIN.concat("manager").includes(user.role)
                  ? <>
                      <button onClick={() => nativeShare(d)} className="w-full rounded-lg py-2.5 text-sm font-bold mb-2 flex items-center justify-center gap-2 active:opacity-70" style={{ background: brand.accent, color: "#fff" }}>
                        📤 अभी Share करें
                      </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80" onClick={() => setCropItem(null)}>
          <div className="bg-neutral-900 rounded-2xl p-4 mx-4 max-w-sm w-full" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-2">
              ...
              <button onClick={() => { nativeShare(cropItem); setCropItem(null); }} className="w-full rounded-xl py-2.5 text-sm font-semibold border-2" style={{ borderColor: brand.accent, color: brand.accent }}>📤 Share करें</button>
