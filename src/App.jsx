...
export default function App() {
  ...
  const [promoForm, setPromoForm] = useState({ model: "", price: "", downPayment: "", cashback: "", features: "", file: null, bg: "light", vehicle: "" });
  ...
  async function submitPromo() {
    ...
    try {
      ...
      if (!res.ok) throw new Error((await res.json().catch(() => ({}))).error || "upload failed");
      setPromoForm({ model: "", price: "", downPayment: "", cashback: "", features: "", file: null, bg: "light", vehicle: "" });
      setTab("content");
    } catch (e) { setErr(e.message); } setBusy(false);
  }
          ...
          <div className="rounded-2xl bg-neutral-900 border border-neutral-800 p-4 mb-5 space-y-3">
            ...
            <div>
              ...
              <div className="flex gap-2 mt-1">
                {[["light", "साफ़ (Honda जैसा)"], ["brand", "ब्रांड रंग"], ["dark", "डार्क"]].map(([v, lbl]) => (
