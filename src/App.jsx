...
export default function App() {
  ...
  const [promoForm, setPromoForm] = useState({ model: "", price: "", downPayment: "", cashback: "", features: "", file: null, bg: "light", vehicle: "", cutout: true, aiPrompt: "" });
  ...
  async function submitPromo() {
    ...
    try {
      ...
      if (!res.ok) throw new Error((await res.json().catch(() => ({}))).error || "upload failed");
      setPromoForm({ model: "", price: "", downPayment: "", cashback: "", features: "", file: null, bg: "light", vehicle: "", cutout: true, aiPrompt: "" });
      setTab("content");
    } catch (e) { setErr(e.message); } setBusy(false);
  }
